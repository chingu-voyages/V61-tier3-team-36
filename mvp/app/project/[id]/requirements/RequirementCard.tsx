    ...
    <div className="border border-zinc-700 rounded-xl p-6 hover:border-zinc-600 transition">
      <div className="flex justify-between items-start">
        ...
        <div className="flex gap-2 ml-6">
          ...
          <button
            className="px-3 py-2 rounded-lg border border-zinc-600 hover:bg-zinc-800"
          >
            Edit
          </button>
          ...
          <button
            ...
            className="px-3 py-2 rounded-lg border border-red-700 text-red-400 hover:bg-red-900/20"
          >
            Delete
          </button>
